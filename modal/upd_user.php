            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" id="upd_user" name="upd_user">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input pattern="[0-9]{10,10}" maxlength="10" name="mod_phone" id="mod_phone" required type="text" class="form-control" placeholder="Teléfono">
                                <span aria-hidden="true">Digite 10 numeros para el teléfono.</span>
                        </div>
                        <div class="form-group">
                            <!--<label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">Contraseña<span class="required">*</span>
                            </label> -->
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="password" placeholder="Nueva Contraseña" id="password" name="password" class="form-control col-md-7 col-xs-12">
