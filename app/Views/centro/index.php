        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    {%  include 'modal/new_centro.php'  %}
                    {%  include 'modal/upd_centro.php'  %}   
...
<script type="text/javascript" src="{{ asset('js/centro.js')}}"></script>
