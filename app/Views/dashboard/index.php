                ...
                <div class="row top_tiles">
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <div class="count">{{plantadata}}</div>
                          <h3>Datos Planta</h3>
                        </div>
                    </div>
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="image view view-first">
                            <img class="thumb-image" style="width: 100%; display: block;" src="images/profiles/{{ user['profile_pic'] }}" alt="image" />
                        </div>
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="action/upd_profile.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="name" id="first-name" class="form-control col-md-7 col-xs-12" value="{{ user['name'] }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input readonly type="text" id="email" name="email" class="form-control col-md-7 col-xs-12" value="{{user['email']}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="phone" id="phone" class="form-control col-md-7 col-xs-12" value="{{user['phone']}}">        <!--Telefono-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input readonly type="text" class="form-control col-md-7 col-xs-12" value="{% if user['kind']==1 %}{{'Administrador'}}{%  elseif(user['kind']==2) %}{{'Usuario'}}{% endif %}"
                                            > 
                                        </div>
                                    </div>
