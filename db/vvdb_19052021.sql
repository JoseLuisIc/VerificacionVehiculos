...
INSERT INTO `centro` VALUES (1,'Recursos Humanos','Departamento de RH'),(2,'Tesoreria','Departamento de Tesorería'),(10,'Ingeniería','Ingeniería');
...
INSERT INTO `modelo` VALUES (3,'KIA-2020','Parte de KIA-2020'),(4,'KIA-2021','Parte de KIA-2021');
...
INSERT INTO `planta` VALUES (1,'Akron','Planta Missipi'),(2,'Arizona','Planta Arizona'),(3,'Celaya','Planta Celaya');
...
CREATE TABLE `plantadata` (
  ...
  `desc_scrap` varchar(100) DEFAULT NULL,
  `costo_std` int DEFAULT NULL,
  `costo_total_prod` int DEFAULT NULL,
...
INSERT INTO `scrap` VALUES (2,'SCRAP','EJEMPLO'),(3,'ABCLDJ','SCRAP CODE');
...
-- Dump completed on 2021-05-19  1:56:12
