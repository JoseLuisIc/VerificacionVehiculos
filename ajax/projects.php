            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <tr class="even pointer">
                        ...
                        <a href="#" class='btn btn-default' title='Editar Projecto' onclick="obtener_datos('<?php echo $id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-udp"><i class="glyphicon glyphicon-edit"></i></a> 
                        <a href="#" class='btn btn-default' title='Borrar Projecto' onclick="eliminar('<?php echo $id; ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span></td>
                    </tr>
                <?php
                    } //end while
                ?>
